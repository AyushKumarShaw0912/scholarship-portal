          ...
          <div className="mx-auto mt-12 max-w-4xl space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="leading-8">
                ...
                talented students from pursuing quality science education.
                Through our scholarship programs, we aim to support deserving
                students preparing for engineering and medical entrance
                examinations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-8">
                ...
                all backgrounds and help them achieve academic excellence
