      ...
      <Container>
        ...
        <div className="mx-auto mt-12 max-w-4xl rounded-2xl border bg-card p-8">
          ...
          <p className="mt-4 leading-8 text-muted-foreground">
            If you have any questions regarding eligibility, required documents,
            the selection process, or the application procedure, please contact
            us via email. We will respond as soon as possible.
          </p>
        </div>
      </Container>
    </Section>
